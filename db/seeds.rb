...
Car.create(
  ...
  address: "Via Giuseppe Giusti, 28, Milano, Metropolitan City of Milan, Italy"
)
...
Car.create(
  ...
  address: "Via Aosta, 4, 20155 Milano MI, Italy"
)
...
Car.create(
  ...
  address: "Paolo Sarpi, Via Messina, Milan, Metropolitan City of Milan, Italy"
)
...
Car.create(
  ...
  address: "Bocconi University, Via Roberto Sarfatti, Milan, Metropolitan City of Milan, Italy"
)
...
Car.create(user: b,
  ...
  address: "Accademia di Belle Arti di Brera, Via Brera, Milan, Metropolitan City of Milan, Italy"
)
...
Car.create(user: c,
  ...
  address: "Dude Club, Via Carlo Boncompagni, Milan, Metropolitan City of Milan, Italy"
)
...
Car.create(user: a,
  ...
  address: "N'Ombra de Vin, Via San Marco, Milan, Metropolitan City of Milan, Italy"
)
...
Car.create(user: b,
  ...
  address: "San Siro, Milan, Metropolitan City of Milan, Italy"
)
...
Car.create(user: c,
  ...
  address: "Via Torquato Tasso, Sesto San Giovanni, Metropolitan City of Milan, Italy"
)
...
Car.create(
  ...
  address: "Cantine Isola, Via Paolo Sarpi, Milan, Metropolitan City of Milan, Italy"
)
...
Car.create(user: b,
  ...
  address: "La Briciola, Milan, Metropolitan City of Milan, Italy"
)
...
Car.create(user: c,
  ...
  address: "Sorbillo, Via Agnello, Milan, Metropolitan City of Milan, Italy"
)
...
Car.create(user: a,
  ...
  address: "Piazza Castello, Milan, Metropolitan City of Milan, Italy"
)
...
Car.create(user: b,
  ...
  address: "Parco Sempione, Piazza Sempione, Milan, Metropolitan City of Milan, Italy"
)
...
Car.create(
  ...
  photo: "https://images.unsplash.com/photo-1519410279512-dab70daa49a6?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=d1ca2cb04bc00814390bff51c433f03a&auto=format&fit=crop&w=2504&q=80",
  address: "Cadorna FN, Milan, Metropolitan City of Milan, Italy"
)
...
Car.create(
  ...
  address: "La Triennale di Milano, Viale Emilio Alemagna, Milan, Metropolitan City of Milan, Italy"
)
...
Car.create(
  ...
  address: "City Life, Milan, Metropolitan City of Milan, Italy"
)
...
Car.create(
  ...
  address: "Piazza Tre Torri, Milan, Metropolitan City of Milan, Italy"
)
